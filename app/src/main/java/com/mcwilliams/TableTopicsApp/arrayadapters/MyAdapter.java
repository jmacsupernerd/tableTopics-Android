...
import com.mcwilliams.TableTopicsApp.activities.ManagePeople;
...
//                imageView = (ImageView) itemView.findViewById(R.id.rowIcon);// Creating ImageView object with the id of ImageView from item_row.xml
    ...
    public MyAdapter(String Titles[], Context mContext, DrawerLayout drawer) { // MyAdapter Constructor with titles and icons parameter
                ...
                public void onClick(View v) {
                    ...
                    switch (v.getTag().toString()) {
                        ...
                        case "Timer":
                            break;
                        case "People":
                            Intent addPeople = new Intent(context, ManagePeople.class);
                            addPeople.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                            context.startActivity(addPeople);
                            break;
                        case "Topics":
                            Intent addTopics = new Intent(context, ManageTopics.class);
                            addTopics.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                            context.startActivity(addTopics);
                            break;
                        default:
                            break;
                    }
