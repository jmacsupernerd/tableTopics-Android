...
/**
 * Created by joshuamcwilliams on 8/15/13.
 */
public class ScrapeTwitter {

    private String twitter_consumer_key = "hynoMjiONZXwMgdwwRGBfQ";
    private String twitter_consumer_secret = "Wnj7XL2iveqHQnDYaaJ69kUfFJ8dxDK7N4zwVjD3Vc";
    ...
    public JSONObject searchTweets(String q) {
        ...
        String oauth_token = "94878026-0USyq5SQDyqHNgXvZ96DMWFgOTcbWd2nXt0gXeTpS";
        String oauth_token_secret = "hNm7hPR6krV5gknfR2yXQMwl4kS4SsWzGuBksQo5I";
